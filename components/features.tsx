  ...
  const featuredFeatures = [
    {
      ...
      benefits: ["Compete against top players worldwide", "Weekly new tournaments to join", "Transparent scoring system"],
      featured: true,
    },
    {
      icon: ZapIcon,
      ...
      benefits: ["Same-day prize distribution", "Multiple payment methods supported", "No hidden fees"],
      featured: true,
    },
  ]
    ...
    <section id="features" className="py-40 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-4xl mx-auto text-center mb-32">
          ...
          <p className="text-xl md:text-2xl text-white/70 leading-relaxed max-w-3xl mx-auto mb-8">
            Competitive gaming platform built for skill-based players
          </p>
          <div className="space-y-2 text-base md:text-lg text-white/60">
            <div className="flex items-center justify-center gap-2">
              <span className="text-[#FF7A1A]">✓</span>
              <span>Fair, transparent voting system for all submissions</span>
            </div>
            <div className="flex items-center justify-center gap-2">
              <span className="text-[#FF7A1A]">✓</span>
              <span>Instant payouts and real cash prizes every week</span>
            </div>
          </div>
        </div>
                     ...
                     <ul className="space-y-2 pt-2">
                       {feature.benefits?.map((benefit, idx) => (
                         <li key={idx} className="flex items-start gap-2 text-white/60 text-sm">
                           <span className="text-[#FF7A1A] font-bold mt-1">●</span>
                           <span>{benefit}</span>
                         </li>
                       ))}
                     </ul>
